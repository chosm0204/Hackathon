    ...
    <div>
      <div className="flex items-center justify-center p-8">
        <div className="w-full p-8 max-w-lg rounded-xl border border-gray-100 shadow-md space-y-6">
          <h2 className="text-center text-[#E387A1] font-bold text-3xl ">
            회원가입
          </h2>
          ...
          <div>
            ...
            <input
              type="name"
              placeholder="이름"
              className="text-[#E387A1] mt-2 px-3 py-2 w-full border border-pink-300 rounded-md shadow-sm"
            />
          </div>
          ...
          <div className="flex items-center justify-end text-sm">
            <a
              href="login"
              className="font-medium text-[#E387A1] hover:underline"
            >
              로그인페이지로
            </a>
          </div>

                ...
                >
                    ...
                    {isActive && place.duration && (
                        <div className="absolute top-1/2 left-[-110px] -translate-y-1/2 bg-white rounded-lg p-2 text-xs border border-gray-300 shadow-sm">
                            <span className="font-semibold">도보 + 버스</span><br />
                            {place.duration}
                        </div>
                    )}
                ...
                <div className="flex items-start gap-5">
                    ...
                    <div className="flex-1">
                            ...
                            <div className="flex items-center gap-1 text-sm">
                                ...
                                <div className="flex items-center">
                                    {[...Array(5)].map((_, i) => (
                                        <svg
                                            key={i}
                                            className={`w-7 h-7 fill-current ${i < Math.floor(activePlace.rating) ? 'text-yellow-500' : 'text-gray-300'}`}
                                            viewBox="0 0 20 20"
                                        >
                                            <path d="M10 15l-5.878 3.09 1.176-6.545L.587 7.645l6.545-.943L10 1l2.868 5.702 6.545.943-4.705 4.09 1.176 6.545z" />
                                        </svg>
                        ...
                        <p className="text-gray-700 text-sm mb-2">
                            <span className="font-semibold">소개 | </span>{activePlace.description}
                        </p>
                        <p className="text-gray-700 text-sm mb-2">
                            <span className="font-semibold">주소 | </span>{activePlace.address}
                        </p>
                        <p className="text-gray-700 text-sm">
                            <span className="font-semibold">주차 | </span>{activePlace.parking}
                        </p>
                    </div>
                </div>
            </div>
